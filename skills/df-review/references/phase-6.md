...
3. Output fixes table per [review-output-format](../../df-review-output-format/SKILL.md)
...
**Comment labels:** Per [review-conventions](../../df-review-conventions/SKILL.md) — prefix every comment with `issue:`/`suggestion:`/`nitpick:`/`praise:`.
